...
/usr/bin/curl -H "Content-Type: application/json" -XPUT '/'$INDEXNAME
/usr/bin/curl -H "Content-Type: application/json" -XPUT '/'$INDEXNAME'/_mapping' --data-binary "@samples/es-account-mapping.json"
